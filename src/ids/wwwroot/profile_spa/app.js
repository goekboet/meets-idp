...
var $author$project$Main$fetchProfile = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotProfile, $author$project$Main$decodeProfile),
		url: A2(
